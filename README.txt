Exam Project for Programmazione Mobile at UNIMORE computer science
Computer graphics with OpenGLES in Androind application
Voxel Renderer, from custom Voxel file format .vly rapresenting Voxel Based Objects
